	...
	<div class="form-group" style="margin-top: 2em;">
		...
		<div class="col-sm-6">
		    <div class="panel panel-danger">
		      <div class="panel-heading">찜한 상품</div>
				...
				<div class="form-group" style="text-align: center; background-color: blue;">
					...
					<div class="col-sm-2">
						<c:if test="${currentPage > 1 }">
							<ul class="pager">
								<li><a href="move_myroom.do?page=${currentPage-1}&member_no=${sessionScope.sessionData.memberInfo.getMember_no()}">Previous</a></li>
							</ul>
						</c:if>
						<c:if test="${currentPage <= 1 }">
							<ul class="pager">
							...
							<c:if test="${not doneLoop }">
								<ul class="pagination">
									<c:if test="${currentPage == page }">
										<li class="active"><a href="move_myroom.do?page=${page}&member_no=${sessionScope.sessionData.memberInfo.getMember_no()}">${page}</a></li>
									</c:if>
									<c:if test="${currentPage != page }">
										<li><a href="move_myroom.do?page=${page}&member_no=${sessionScope.sessionData.memberInfo.getMember_no()}">${page}</a></li>
									</c:if>
								</ul>
					...
					<div class="col-sm-2">
						<c:if test="${currentPage < totalPage }">
							<ul class="pager">
								<li><a href="move_myroom.do?page=${currentPage+1}&member_no=${sessionScope.sessionData.memberInfo.getMember_no()}">Next</a></li>
							</ul>
						</c:if>
						<c:if test="${currentPage >= totalPage }">
							<ul class="pager">
